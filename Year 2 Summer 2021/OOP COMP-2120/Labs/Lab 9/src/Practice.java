...
public class Practice {
    public static void main(String[] args){
        Practice T = new Practice("Screw", "This is an Important device to Screw Yourself with", 10, 100);
        ...
        private String partNumber;
            ...
            public Practice(String part, String description, int count, double price) {
                partNumber = part;
