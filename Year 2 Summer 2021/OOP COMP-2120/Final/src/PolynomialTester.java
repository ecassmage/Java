...
public class PolynomialTester
{
   public static void main(String[] args)
   {
      ...
      if (p1.compareTo(p2)>0)
         System.out.println("P1(x) is greater than P2(x)");
      if (p1.compareTo(p2)<0)
         System.out.println("P1(x) is less than P2(x)");
      ...
      p3.add(new Polynomial(3,0));
      System.out.println("P3(x) = " + p3);
      System.out.println("P2(x) = " + p2);
      System.out.println("P3(x) " + (p2.equals(p3)?"is equal to P2(x)":"is not equal to P2(x)"));
      if (p3.compareTo(p2)>0)
         System.out.println("P3(x) is greater than P2(x)");
      if (p3.compareTo(p2)<0)
         System.out.println("P3(x) is less than P2(x)");
      for (int[] num: p3.listSorted){
         System.out.println(num[0] + " " + num[1]);
      }System.out.println();
      for (int[] num: p2.listSorted){
         System.out.println(num[0] + " " + num[1]);
      }System.out.println();
      for (int[] num: p1.listSorted){
         System.out.println(num[0] + " " + num[1]);
      }System.out.println();
      for (int[] num: q.listSorted){
         System.out.println(num[0] + " " + num[1]);
      }System.out.println();
   }
